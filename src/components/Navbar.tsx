    ...
    >
      <Menu setActive={setActive}>
        ...
        <MenuItem setActive={setActive} active={active} item="Partner Models">
          <div className="flex flex-col space-y-4 text-sm">
            <HoveredLink href="/FOCO">Lets do it</HoveredLink>
            <HoveredLink href="/FOFO">Let us support</HoveredLink>
        ...
        <MenuItem setActive={setActive} active={active} item="Events">
          <div className="flex flex-col space-y-4 text-sm">
            ...
            <HoveredLink href="/Recognition">Celebrations</HoveredLink>
            <HoveredLink href="/Awards and Achievements">Enterprise</HoveredLink>
          </div>
        </MenuItem>
      </Menu>
    </div>
